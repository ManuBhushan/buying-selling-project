...
import { createAd, deleteParticularAd, getAllAdsWithogin, getAllAdsWithoutLogin, getOwnAds, getParticularAd, getSearchedAdsWithLogin, getSearchedAdsWithoutLogin, getUserInfo, myAds, updateAdSoldStatus } from "../controllers/adController";
